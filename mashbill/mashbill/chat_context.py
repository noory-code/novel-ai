...
WRITE_PLAYBOOK = (
    ...
    "a different canvas. When the node's label is still a placeholder "
    "(Mission, Core value, Voice), set a short meaningful label in the same "
    "update_node call — a filled node must not look untouched. Do not "
