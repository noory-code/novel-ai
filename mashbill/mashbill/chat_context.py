...
SCOPE_FRAMING: dict[str, str] = {
    ...
    "services": (
        ...
        "slots as you go, and a feature's subject comes from ITS "
        "service's participants (narrowing). Promotion "
        "test: a feature "
        ...
        "TOUCHPOINT sweep: group services into categories — a category IS "
        "a touchpoint (접점: where the product meets its people — 고객 앱, "
        "사장님 웹) — and set each touchpoint's ref_actor_ids to the "
        "families who meet it; a service's participants stay within its "
        "touchpoint's. ENTITIES ARE YOUR OWN JUDGMENT (the "
