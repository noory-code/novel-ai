...
SCOPE_FRAMING: dict[str, str] = {
    "foundation": (
        ...
        "BATCH, not a drip: once the talk holds two or three candidates, put "
        "them on the table together and register every confirmed one in the "
        "same turn — one value per turn caps the session at two or three. Identity lands "
...
PROPOSE_PLAYBOOK = (
    ...
    "content. Proposing never loosens the save gate: save "
