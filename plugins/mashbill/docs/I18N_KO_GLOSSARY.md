...
>
> **Pairs with:**
> - [`../CLAUDE.md`](../CONTRIBUTOR_GUIDE.md) i18n anti-pattern row — the rule "Novel is a
>   global service, i18n is non-negotiable" (originally a user-direction memory note).
> - [`../../docs/concepts/kinds.md`](https://github.com/noory-code/novel-ai/blob/main/docs/concepts/kinds.md) — the canonical public vocabulary
>   for Novel kinds.
