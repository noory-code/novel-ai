...
[`VISION.md`](https://github.com/noory-code/novel-ai/blob/main/docs/VISION.md) and [`CONCEPTS.md`](CONCEPTS.md)
...
**Why it matters:** Novel's essence ([`VISION.md`](https://github.com/noory-code/novel-ai/blob/main/docs/VISION.md))
