...
> ⚠ **kind 필드 정본 = [`../../../docs/specs/kinds-fields.md`](https://github.com/noory-code/novel-ai/blob/main/docs/specs/kinds-fields.md)**
...
>
> **개념 정본:** [`../../../docs/concepts/kinds.md`](https://github.com/noory-code/novel-ai/blob/main/docs/concepts/kinds.md) —
