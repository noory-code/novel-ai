...
- 정체성으로 흡수했나: 창업자는 목소리·태도를 묻는 질문에도 가치로 답한다("복잡함보다 명확한
  고객경험을 택해야 해요"). 그 문장이 무엇을 **포기하는지**(기능 밀도·설명 여지) 말하고 있으면
  그건 가치다 — 정체성 문장으로 다듬고 끝내면 가치 지도에서 사라진다. 정체성으로 쓰더라도
  가치로도 남긴다(둘은 배타적이지 않다). 판별: "지금 정체성으로 적은 문장 중, 포기하는 대가가
  들어 있어 가치로도 서야 하는 것은?"
...
- 가치를 삼키지 마라: 정체성을 세우는 대화에서 창업자가 "무엇을 포기하고 무엇을 택한다"는
  문장으로 답하면, 그건 목소리가 아니라 가치다. 정체성 문장으로 다듬되 가치 지도에도 남긴다.
  판별: "방금 정체성으로 흡수한 문장 중 대가가 들어 있는 것은 없나?"
