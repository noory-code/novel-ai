...
project's work. Tools like [Novel](https://github.com/noory-code/novel-ai/tree/main/plugins/mashbill)
and [Solera](https://github.com/noory-code/novel-ai/tree/main/plugins/solera) do not own
...
Codex installs the same package with `codex plugin add proof@novel-ai` after
adding the repository marketplace. Gemini CLI receives the Proof MCP server
through the root extension. See the [host support matrix](../../docs/HOST_SUPPORT.md).
