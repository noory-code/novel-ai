...
Artifacts are promoted incrementally via `transition-catalog`, not in bulk:
...
| Create artifact directly in `published/` | Create in `artifacts/`, promote via `transition-catalog` |
