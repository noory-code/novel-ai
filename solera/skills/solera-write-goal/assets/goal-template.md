...
### Step 0. Setup
- [ ] Confirm `published/identity/mission.md` exists; if missing, invoke solera-write-identity
...
#### Epic: {number}-{name}
- [ ] solera-write-epic invoke (Setup → Create → Execute → Wrap-up)
- [ ] solera-create-pr invoke (PR to parent branch)
<!-- /repeat -->
