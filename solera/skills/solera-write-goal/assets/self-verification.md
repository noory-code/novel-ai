# Validation: solera-write-goal

> This file defines the unique validation rules for the solera-write-goal skill.
...
```yaml
semantic:
  - {id: C-001, name: "Epic repeat block", type: content_contains, target: assets/goal-template.md, patterns: ["solera-write-epic invoke", "<!-- /repeat -->"]}
