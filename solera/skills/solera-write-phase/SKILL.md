...
| `solera-transition-catalog` | Promote artifacts incrementally (at Goal Create and Epic Wrap-up) | Execute (within Goal/Epic) |
...
| solera-write-goal 실패 | 하위 스킬 호출 실패 | 실패한 Goal 기록, 사용자에게 알림 | 해당 Goal 건너뛰고 계속 진행 또는 중단 |
