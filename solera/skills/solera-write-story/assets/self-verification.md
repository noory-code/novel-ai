...
```yaml
semantic:
  - {id: C-001, name: "Action Item decomposition reference", type: content_contains, target: SKILL.md, patterns: ["solera-execute-action-item", "Action Items"]}
  ...
  - {id: C-008, name: "Retrospective reference", type: content_contains, target: assets/story.md, patterns: ["RETROSPECTIVE.md", "retro.md"]}
  ...
  - {id: C-025, name: "retro requires Concept Contribution Summary", type: content_contains, target: assets/retro.md, patterns: ["Concept Contribution Summary"]}
