...
semantic:
  ...
  - {id: C-008, name: "Retrospective write reference", type: content_contains, target: assets/story.md, patterns: ["Write retrospective", "RETROSPECTIVE.md"]}
  ...
  - {id: C-013, name: "Wrap-up procedure exists", type: content_contains, target: SKILL.md, patterns: ["Wrap-up", "RETROSPECTIVE.md", "Squash merge"]}
